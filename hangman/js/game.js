...
window.HangmanGame = {
    ...
    wordsWithHints: [
        ...
        // Animais
        { word: 'ELEFANTE', hint: 'Maior animal terrestre, tem tromba' },
        { word: 'GIRAFA', hint: 'Animal com pescoço muito longo' },
        { word: 'LEAO', hint: 'Rei da selva' },
        { word: 'PINGUIM', hint: 'Ave que nada e vive no gelo' },
        { word: 'TARTARUGA', hint: 'Reptil com casco duro e lento' },
        { word: 'GOLFINHO', hint: 'Mamífero marinho muito inteligente' },
        { word: 'BORBOLETA', hint: 'Inseto colorido que sofre metamorfose' },
        { word: 'CANGURU', hint: 'Animal australiano que pula' },

        // Comida
        { word: 'CHOCOLATE', hint: 'Doce feito de cacau' },
        { word: 'PIZZA', hint: 'Massa redonda com recheio e queijo' },
        { word: 'HAMBURGUER', hint: 'Sanduíche de carne moída' },
        { word: 'SORVETE', hint: 'Sobremesa gelada e cremosa' },
        { word: 'MACARRAO', hint: 'Massa italiana, espaguete' },
        { word: 'PIPOCA', hint: 'Milho estourado no calor' },

        // Objetos
        { word: 'TELEFONE', hint: 'Usado para falar à distância' },
        { word: 'RELOGIO', hint: 'Marca as horas' },
        { word: 'ESPELHO', hint: 'Reflete sua imagem' },
        { word: 'CADEIRA', hint: 'Móvel para sentar' },
        { word: 'LAMPADA', hint: 'Produz luz artificial' },
        { word: 'BICICLETA', hint: 'Veículo de duas rodas a pedal' }
    ],
